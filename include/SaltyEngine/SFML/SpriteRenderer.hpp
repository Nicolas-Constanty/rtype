...
namespace SaltyEngine
{
	namespace SFML
	{
		...
		{
		public:
			SpriteRenderer(const std::string &name, GameObject * const gameObj, Sprite * const sprite, Layout layer, Window * const w = nullptr) : ASpriteRenderer(name, gameObj, sprite, layer)
			{
				Renderer::AddSpriteRenderer(this);
				m_window = w;
			}
			SpriteRenderer(GameObject* const gameObj, Sprite * const sprite, Layout layer, Window * const w = nullptr) : ASpriteRenderer("SpriteRenderer", gameObj, sprite, layer)
			{
				Renderer::AddSpriteRenderer(this);
				m_window = w;
			}
